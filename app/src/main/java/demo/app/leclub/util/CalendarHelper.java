...
public class CalendarHelper {
    ...
    public static long makeNewCalendarEntry(Activity caller, String title, String description, String location, long startTime, long endTime, boolean allDay, boolean hasAlarm, int calendarId, int selectedReminderValue) {
    ...
    public static int deleteCalendarEntry(Activity caller, long entryID) {
        int iNumRowsDeleted;
